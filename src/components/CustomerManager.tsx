        ...
        <div className="bg-white p-4 md:p-5 rounded-[1.5rem] shadow-xl border border-slate-100 animate-in slide-in-from-top-4 duration-500 max-w-3xl mx-auto w-full space-y-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 bg-slate-50/50 p-2.5 rounded-xl border border-slate-50">
              ...
              <div className="space-y-1">
                <label className="text-[8px] font-black text-slate-400 uppercase tracking-widest ml-1">Email <span className="lowercase font-medium opacity-50">(Opsional)</span></label>
                <input 
                  type="email" 
                  className="w-full px-3 py-2 rounded-lg border border-slate-200 bg-white outline-none font-bold text-slate-700 text-xs shadow-sm" 
                  placeholder="email@..."
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-1.5 mt-0.5">
                        ...
                        {c.email && <span className="text-[9px] text-slate-300 font-bold truncate max-w-[100px]">{c.email}</span>}
                      </div>
                    </div>
                  </div>
                    ...
                    <td className="px-5 py-3">
                      <div className="flex items-center gap-2">
                        ...
                        <div className="min-w-0">
                          ...
                          {c.email && <p className="text-[9px] text-slate-400 flex items-center gap-1 font-bold truncate tracking-tight uppercase">{c.email}</p>}
                        </div>
                      </div>
                    </td>
                    <td className="px-5 py-3">
