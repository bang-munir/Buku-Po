      ...
      <div className="bg-white p-3 rounded-2xl border border-slate-100 shadow-sm space-y-3">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 px-1">
           ...
           <div className="flex gap-2 w-full sm:w-auto overflow-x-auto no-scrollbar pb-1">
              <button onClick={() => setPreset('today')} className="px-2.5 py-1 bg-slate-50 border border-slate-100 rounded text-[8px] font-black uppercase text-slate-500 hover:bg-white active:scale-95 transition-all">Hari Ini</button>
              <button onClick={() => setPreset('week')} className="px-2.5 py-1 bg-slate-50 border border-slate-100 rounded text-[8px] font-black uppercase text-slate-500 hover:bg-white active:scale-95 transition-all">7 Hari</button>
              <button onClick={() => setPreset('month')} className="px-2.5 py-1 bg-slate-50 border border-slate-100 rounded text-[8px] font-black uppercase text-slate-500 hover:bg-white active:scale-95 transition-all">30 Hari</button>
           </div>
