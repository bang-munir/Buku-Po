...
const supabaseUrl = env.VITE_SUPABASE_URL || 'https://yndmiwxpfkcqsdfpynak.supabase.co';
const supabaseAnonKey = env.VITE_SUPABASE_ANON_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InluZG1pd3hwZmtjcXNkZnB5bmFrIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzA0Njc1NzAsImV4cCI6MjA4NjA0MzU3MH0.HhpUUsOtk6dn6YHOjvbvltI9DLBOOiBOTozLMFdlgCE';
